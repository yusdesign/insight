...
async function comprehensiveTest() {
    console.log('🚀 JS2UML + Insight Suite Integration Test\n');
    ...
    try {
        ...
        console.log('📊 INSIGHT SUITE ANALYSIS RESULTS:');
        ...
        console.log('💾 Saved visualizations:');
        console.log('  • outputs/insight-analysis.html (PlantUML)');
        console.log('  • outputs/insight-analysis.txt (ASCII)');
        console.log('  • outputs/insight-analysis-enhanced.puml (Enhanced)');
